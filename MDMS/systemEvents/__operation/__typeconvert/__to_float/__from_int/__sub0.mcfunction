...
scoreboard players operation @e[type=area_effect_cloud,tag=MDMS_op_temp] MDMS_tempCal = MDMS_op_A_int MDMS_tempCal
scoreboard players operation MDMS_op_result_float_factor MDMS_tempCal = MDMS_op_A_int MDMS_tempCal
